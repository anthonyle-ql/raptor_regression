...
//
assign WBs_ADR_i2c         =    CQ_Busy          ?  WBs_ADR_CQ             : WBs_ADR_i[2:0] ;
assign WBs_CYC_i2c         =    CQ_Busy          ?  WBs_CYC_CQ             : WBs_CYC_I2C_i  ;
assign WBs_DAT_i_i2c       =    CQ_Busy          ?  WBs_DAT_o_CQ           : WBs_DAT_i[7:0] ;
assign WBs_WE_i2c          =    CQ_Busy          ?  WBs_WE_CQ              : WBs_WE_i       ;
assign WBs_STB_i2c         =    CQ_Busy          ?  WBs_STB_CQ             : WBs_STB_i      ;


// Select the source of control signals from the I2C Master and TxFIFO logic
//
assign WBs_DAT_o_I2C_o     =    CQ_Busy          ?  I2C_DEFAULT_READ_VALUE : {{(DATAWIDTH-8){1'b0}}, WBs_DAT_o_i2c};


// Determine the final Wishbone bus acknowledge
//
assign WBs_ACK_o           = (  CQ_Busy  &  WBs_ACK_Default )        
						   | ((~CQ_Busy) &  WBs_ACK_i2c     )
                           |                WBs_ACK_CQ       ;
